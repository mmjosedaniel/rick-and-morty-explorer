...
- **Execution plan:** The active [TASK-002 Sequelize migration-lifecycle decision ExecPlan](./plans/TASK-002-sequelize-migration-lifecycle-decision.md) defines the research, approval, validation, and documentation-closure path without selecting or implementing a runner.
- **Mapped scope:** FR-BE-003, FR-BE-004, NFR-003, DEL-002, AC-009, AC-012; OR-001 (adopted optional).
- **Governing decisions:** ADR-0001, ADR-0002, ADR-0003, ADR-0008, ADR-0010, ADR-0011.
- **Prerequisites and gates:** None; this task is immediately ready, may run in parallel with TASK-003 and TASK-016, and resolves DG-002.
...
- **Prerequisites and gates:** TASK-001; do not add artifacts controlled by unresolved DG-002, DG-003, or DG-004.
