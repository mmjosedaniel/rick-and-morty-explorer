...
- **Status:** Historically Resolved by now-Superseded [ADR-0012](./adrs/0012-use-a-build-first-programmatic-migration-lifecycle.md); accepted [ADR-0015](./adrs/0015-use-a-build-first-migration-lifecycle-with-exact-catalog-byte-lock-identity.md) is the current whole-record authority. No migration runner, migration, migrated database, or ERD exists yet.
...
- **Status:** Resolved by fresh independent `PASS` and explicit project-owner approval of exact [ADR-0015](./adrs/0015-use-a-build-first-migration-lifecycle-with-exact-catalog-byte-lock-identity.md) proposal SHA-256 `8B7B9EC9508DF01E57EA067344896814CD0B0B1B3D8083B889C7ED44AA5432B1` on 2026-08-14. ADR-0015 is accepted and ADR-0012 is reciprocally superseded. No migration runner, migration, migrated database, or ERD exists.
...
| TASK-004 | Pending | TASK-002, TASK-003 | Separate project-owner execution authorization; DG-005 is Resolved and AUTH-001 is Authorized |
...
- **Prerequisites and gates:** TASK-002; achieved. TASK-018 is `Complete`, DG-005 is `Resolved`, and TASK-004 remains `Pending` pending separate execution authorization.
