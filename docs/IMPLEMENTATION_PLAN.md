...
|---|---|---|---|---|
| DG-001 | Resolved | [ADR-0018](./adrs/0018-define-the-typescript-test-harness-with-repository-owned-smoke-orchestration.md) carries forward the Vitest, jsdom, milestone-aware unit/integration/application, and one-worker Chromium boundaries from now-Superseded ADR-0011 while assigning smoke application-process ownership to the bounded repository TypeScript orchestrator. | Resolved direction may be implemented only by owning tasks. Acceptance is not harness, clean/hosted, or product evidence; TASK-010 Milestone 2 still owes its changed-boundary clean/hosted proof. | NFR-004; OR-001, OR-004, OR-007 (adopted optional); ADR-0001 (Superseded), ADR-0002, ADR-0010 (Superseded), ADR-0011 (Superseded), ADR-0014, ADR-0016, ADR-0018 |
