...
The repository has completed TASK-003 through TASK-013 after establishing the initial requirements and architecture foundation. TASK-007 completed its finite Redis behavior and hosted lifecycle; TASK-010 through TASK-012 completed the list, detail, interaction, responsive, and resilient browser experience; and TASK-013 completed exact-pinned typed lint and portfolio relevance. TASK-014 is reopened as `In progress` under corrective workflow `TASK-014-20260822-02` after a post-closure independent review found the public README incomplete and the accepted ADR-0006 development-only explorer composition missing. AC-001 through AC-011 pass; AC-012 is reopened, so minimum-assessment readiness is 11/12. TASK-015 remains `Pending` for the separate repository-baseline review.
...
- **Status:** Historically Resolved by now-Superseded [ADR-0012](./adrs/superseded/0012-use-a-build-first-programmatic-migration-lifecycle.md); accepted [ADR-0015](./adrs/0015-use-a-build-first-migration-lifecycle-with-exact-catalog-byte-lock-identity.md) is the current whole-record authority. Completed TASK-004 supplies the migration lifecycle, and completed TASK-014 supplies the migration-derived public ERD and clean-clone comparison.
...
- **Status:** Resolved by fresh independent `PASS` and explicit project-owner approval of exact [ADR-0015](./adrs/0015-use-a-build-first-migration-lifecycle-with-exact-catalog-byte-lock-identity.md) proposal SHA-256 `8B7B9EC9508DF01E57EA067344896814CD0B0B1B3D8083B889C7ED44AA5432B1` on 2026-08-14. ADR-0015 is accepted and ADR-0012 is reciprocally superseded. Completed TASK-004 supplies the successor lifecycle, and completed TASK-014 supplies the public migration-derived ERD and clean-clone validation.
...
| TASK-014 | In progress | TASK-013 | Corrective workflow `TASK-014-20260822-02` owns the missing development-only explorer composition and README privacy/redirect/migration corrections after independent `REVISE` |
| TASK-015 | Pending | TASK-014 | Blocked until corrected TASK-014 delivery and ADR compatibility pass |
...
TASK-003 is `Complete` after TASK-001 completion, DG-001 resolution, separate project-owner execution authorization, successful implementation/runtime verification, and its documentation gate. TASK-002, TASK-004 through TASK-013, and TASK-016 through TASK-018 are also `Complete`; ADR-0015 through ADR-0018 are accepted; all decision gates are resolved; and AUTH-001 is `Authorized` under disposition A. TASK-004 through TASK-013 retain their accepted product, quality, hosted, and cleanup evidence. TASK-014's prior public commit still proves SPEC-015/DEL-001 and SPEC-016/DEL-002, but the current revision review reopens SPEC-017, HS-018, DEL-003, and AC-012 pending workflow `TASK-014-20260822-02`. Current minimum-assessment readiness is 11/12. TASK-015 remains `Pending` and owns the final repository-baseline review after TASK-014 closes.
...
- **Execution plan:** Active corrective [workflow `TASK-014-20260822-02`](./plans/TASK-014-delivery-correction.md) implements the project-owner-selected development-explorer route and corrects the README findings preserved by the [independent revision review](./reviews/2026-08-22-task-014-independent-revision-review.md). The [completed predecessor](./plans/completed/TASK-014-reproducible-repository-evidence.md) preserves workflow `TASK-014-20260822-01`, public commit `62aa3fa7c794e17a52218c0b3fcb4f01e331af9c`, clean-clone evidence, and its historical closure. DEL-001 and DEL-002 remain passed; DEL-003 and AC-012 are reopened, and TASK-014 is `In progress`.
- **Prerequisites and gates:** TASK-013 completed.
- **Reuse and corrective milestone:** Existing Yoga opt-in rendering and default-disabled application behavior are covered. The missing supported-development composition requires only `config.ts`, its existing unit test, and `server.ts`; the README correction covers the exact avatar privacy/redirect disclosure, dev/production explorer truth, and admitted-schema migration wording. No dependency, manifest, environment file, schema, route, migration, ERD, frontend, or GraphQL contract change is planned.
