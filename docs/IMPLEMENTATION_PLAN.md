...
| TASK-004 | In progress | TASK-002, TASK-003 | Implementation and owned Windows verification pass; committed clean-checkout, hosted CI, fresh independent review, and documentation closure remain |
