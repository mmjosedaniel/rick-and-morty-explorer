...
- Active implementation plan: [TASK-010 character list, sorting, and interface filters](../plans/TASK-010-character-list-sorting-and-interface-filters.md)
