...
- Status: TASK-010 list and TASK-011 detail/interaction UI implemented; TASK-012 resilient/responsive closure remains pending; non-blocking Storybook pilot proposed
