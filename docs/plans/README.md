...
| TASK-003 | None; DG-001 is resolved | [Establish the operational walking skeleton](./TASK-003-operational-walking-skeleton.md) | Executing | In progress |
