...
| TASK-011 | None; prerequisites TASK-008 and TASK-010 are Complete; AUTH-001 is Authorized | [Deliver character detail, favorites, and comments](./TASK-011-character-detail-favorites-and-comments.md) | Planned; awaiting separate project-owner execution authorization | Pending |
...
TASK-008 is `Complete` under project-owner-authorized workflow `TASK-008-20260821-01`. Its [completed ExecPlan](./completed/TASK-008-persist-favorite-and-comment-mutations.md) records the lean backend-only mutation path, sequential worker leases, review corrections, exact closure evidence, integrated `PASS`, documentation gate, and the later README example correction confirmed by the [documentation re-review](../reviews/2026-08-21-task-008-documentation-re-review.md). AC-004/AC-005 remain pending until TASK-011 supplies the user-visible interaction evidence.

TASK-011 is `Pending` under its [active ExecPlan](./TASK-011-character-detail-favorites-and-comments.md). The plan records a clean-tree reuse audit, exactly one planned new production component, two coherent frontend-visual product milestones, one standard closure milestone, exact mutation-refetch/error behavior, and explicit TASK-006/TASK-008/TASK-012 exclusions. Planning did not authorize execution or create implementation evidence; separate project-owner authorization and the coordinator-owned activation transition are next.

`Complete` for TASK-001 through TASK-010 except TASK-011, plus TASK-016 through TASK-018, means each listed task's task-specific outcome and documentation gates passed. TASK-007's plan preserves three accepted behavior milestones, the original exact candidate, the later unit reproducibility correction, the hosted-CI contradiction, and the final merged correction/pass. Completed TASK-008 preserves its backend-only mutation milestone, corrections, integrated acceptance, and exact persistence/lifecycle evidence. Completed TASK-010 preserves three milestones, bounded review corrections, integrated acceptance, and exact browser/lifecycle evidence. The owner's option A assigns bounded comment reads to TASK-006 and mutations to TASK-008. AC-001, AC-002, AC-007, AC-008, AC-009, AC-010, and AC-011 product behavior passes; overall minimum-assessment readiness remains `Fail` at 7/12.
