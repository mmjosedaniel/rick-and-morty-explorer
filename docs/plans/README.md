...
| TASK-006 | None; DG-006 is Resolved and AUTH-001 is Authorized | [Expose GraphQL reads, filters, and request logging](./TASK-006-graphql-reads-filters-and-request-logging.md) | Active; Milestones 1-3 accepted; detail/comment reconciliation pending before Milestone 4 | In progress |
