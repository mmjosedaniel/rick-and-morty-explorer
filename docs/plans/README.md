...
| TASK-012 | None; prerequisite TASK-011 is Complete; AUTH-001 is Authorized | [Complete responsive and resilient UI states](./TASK-012-responsive-and-resilient-ui-states.md) | Implementation-ready; pending separate execution authorization | Pending |
...
TASK-012 remains `Pending` under prospective workflow `TASK-012-20260821-01` and its [active ExecPlan](./TASK-012-responsive-and-resilient-ui-states.md). The plan accepts a zero-new-owner reuse audit, extends only the existing card/detail/style and test/smoke owners, and defines one frontend-visual product milestone plus closure. Planning does not authorize implementation or advance AC-006.
