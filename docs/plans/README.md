...
| TASK-008 | None; prerequisite TASK-006 is Complete | [Persist favorite and comment mutations](./TASK-008-persist-favorite-and-comment-mutations.md) | Planned; execution requires separate owner authorization | Pending |
...
TASK-008 remains `Pending`. Its [active ExecPlan](./TASK-008-persist-favorite-and-comment-mutations.md) records a lean backend-only mutation path and does not authorize implementation or change AC-004/AC-005. Separate project-owner authorization and canonical activation are required before worker preflight or any source/test write.

`Complete` for TASK-001 through TASK-007, TASK-009, TASK-010, TASK-016, TASK-017, and TASK-018 means their task-specific outcome and documentation gates passed. TASK-007's plan preserves three accepted behavior milestones, the original exact candidate, the later unit reproducibility correction, the hosted-CI contradiction, and the final merged correction/pass. Completed TASK-010 preserves three milestones, bounded review corrections, integrated acceptance, and exact browser/lifecycle evidence. The owner's option A assigns bounded comment reads to TASK-006 and mutations to TASK-008. AC-001, AC-002, AC-007, AC-008, AC-009, AC-010, and AC-011 product behavior passes; overall minimum-assessment readiness remains `Fail` at 7/12.
