...
| TASK-009 | DG-003 | [Select the frontend GraphQL client and query cache](./TASK-009-frontend-graphql-client-decision.md) | In progress; R2 contract frozen before comparative research | In progress |
...
TASK-009 is `In progress` only for owner-authorized DG-003 research and Proposed-ADR preparation under its active ExecPlan. DG-003 remains `Pending`, no option is approved, and no frontend implementation artifact is authorized.
