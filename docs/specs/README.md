...
Each scenario remains `Specified, not executed` until its owning task implements an ordinary automated check through the ADR-0011 boundary, every other applicable gate is resolved, and the authoritative validation command passes. The feature files themselves remain non-executable even when ordinary tests establish their outcomes. Completed TASK-004 migration evidence plus completed TASK-005 deterministic initialization evidence makes SPEC-010 and AC-009 pass. TASK-005 also makes HS-012 pass and completes its PostgreSQL-authority/import contribution to SPEC-011; full SPEC-011 remains incomplete because TASK-008 still owns favorite/comment mutations. TASK-007 product evidence makes SPEC-012, HS-013, AC-010, and the Redis portion of NFR-003 pass; its hosted task-closure gate is reopened only for the missing CI namespace. DEL-002 and AC-012 remain pending through TASK-014 and TASK-015. Acceptance of ADR-0014 and Authorized AUTH-001 alone do not make an image scenario pass, but TASK-005 proves exact URL ingestion, TASK-006 proves exact stored-URL GraphQL projection, and TASK-007 proves the finite Redis projection. DG-002, DG-003, and DG-005 are resolved; accepted direction alone does not implement their downstream behavior.
...
| Redis cache-aside | SPEC-012, HS-013 | TASK-007 owns passing product evidence and an active hosted-CI namespace correction |
