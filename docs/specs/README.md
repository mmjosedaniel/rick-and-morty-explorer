...
| Migrations and relational model | SPEC-010, HS-002, HS-011 | Completed TASK-018 owns the accepted ADR-0015/DG-005 decision evidence; TASK-004 owns implementation only after separate execution authorization |
